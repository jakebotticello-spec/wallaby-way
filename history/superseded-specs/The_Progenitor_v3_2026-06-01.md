...
*file: The_Progenitor_v3_2026-06-01.md · v3 · apparatus S26 (authored §0–§9 at S24, §10–§13 folded S25, §12–§13 rewritten S26) · supersedes v2 (tombstoned-not-deleted) · read with JAKE-RULES + JAKE-STACK*
...
**NON-NEGOTIABLE GUARDS (restating §8 at the process level):** (1) SOURCE IS THE FLOOR, never chat_search. (2) NOT A ONE-DAY BUILD. (3) APPLY THIS DOCTRINE AS THE BAR — §3's actionability test, two kinds, default-don't-point, complete-over-fences / sparse-over-motion; tens of thousands of pointers = the bar slipped; target hundreds-to-low-thousands. (4) TREE-AWARE SPANS ONLY — parent-up / branch-down, never flat-N. (5) LAY FENCES AS CHAINS even at length-1. (6) KEYWORD COVERAGE IS A SEEDING-QUALITY CRITERION (§8) — laid for future-search-anticipation; measured in use (the maintenance-pass list), not asserted at lay-time.
