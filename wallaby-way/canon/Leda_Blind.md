...
*build spec · child of `Leda.md` (umbrella) · the reverse-sieve · a roaming instrument of the divergent arm (Bouquet, Callosum P5)*
*renamed 2026-06-14 (Sidequest S1 "Cooper") from `The_Blind_Picker_v1.md` into the Leda family; parent re-pointed `The_Feral_Picker_v1.md` → `Leda.md` (the old umbrella was superseded by Leda at S60). The LOCKED §2 instruction block is UNTOUCHED — same bytes, same register; only the masthead pointer and filename changed.*
